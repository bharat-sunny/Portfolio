...
export default function BackgroudCircle({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center'>
        ...
        <div className='rounded-full border border-[#712222] h-[300px] w-[300px] absolute mt-52'></div>
        <div className='rounded-full border border-[#333333] h-[500px] w-[500px] absolute mt-52'></div>
        <div className='rounded-full border border-[#aa5858] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse'></div>
